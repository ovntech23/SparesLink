import { Shop, Part, VehicleType } from '@/types';

export const VEHICLE_DATA: Record<string, string[]> = {
  'Toyota': ['Hilux', 'Land Cruiser', 'Corolla', 'Prado', 'RAV4', 'Fortuner', 'Hiace'],
  'Nissan': ['Navara', 'Patrol', 'NP300', 'X-Trail', 'Qashqai', 'Hardbody'],
  'Mitsubishi': ['Pajero', 'L200', 'Eclipse Cross', 'Outlander', 'Canter'],
  'BMW': ['3 Series', '5 Series', 'X5', 'X3', '1 Series', '7 Series'],
  'Mercedes-Benz': ['C-Class', 'E-Class', 'G-Class', 'Sprinter', 'ML', 'GLE'],
  'Isuzu': ['D-Max', 'MU-X', 'ELF', 'KB Series', 'FRR', 'NPR'],
  'Ford': ['Ranger', 'Everest', 'Ecosport', 'Transit', 'Explorer'],
  'Honda': ['Fit', 'Accord', 'CR-V', 'HR-V', 'Civic'],
  'Suzuki': ['Jimny', 'Swift', 'Grand Vitara', 'Alto', 'Ertiga'],
};
...
export const SHOPS: Shop[] = [
  ...
  },
  {
    ...
    reviewCount: 97,
    isPro: false,
    isVerified: true, // Make sure verified is consistent
  }
];
